...
mixin _$AccountHistoryElement {
 ...
 int get id; int get accountId; String get name; AccountHistoryChangeType get changeType; AccountState? get previousState; AccountState get newState; DateTime get changeTimestamp; DateTime get createdAt;
/// Create a copy of AccountHistoryElement
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$AccountHistoryElementCopyWith<AccountHistoryElement> get copyWith => _$AccountHistoryElementCopyWithImpl<AccountHistoryElement>(this as AccountHistoryElement, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AccountHistoryElement&&(identical(other.id, id) || other.id == id)&&(identical(other.accountId, accountId) || other.accountId == accountId)&&(identical(other.name, name) || other.name == name)&&(identical(other.changeType, changeType) || other.changeType == changeType)&&(identical(other.previousState, previousState) || other.previousState == previousState)&&(identical(other.newState, newState) || other.newState == newState)&&(identical(other.changeTimestamp, changeTimestamp) || other.changeTimestamp == changeTimestamp)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt));
}
...
abstract mixin class $AccountHistoryElementCopyWith<$Res>  {
  factory $AccountHistoryElementCopyWith(AccountHistoryElement value, $Res Function(AccountHistoryElement) _then) = _$AccountHistoryElementCopyWithImpl;
@useResult
$Res call({
 int id, int accountId, String name, AccountHistoryChangeType changeType, AccountState? previousState, AccountState newState, DateTime changeTimestamp, DateTime createdAt
});
...
class _AccountHistoryElement implements AccountHistoryElement {
  const _AccountHistoryElement({required this.id, required this.accountId, required this.name, required this.changeType, required this.previousState, required this.newState, required this.changeTimestamp, required this.createdAt});
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$AccountHistoryElementCopyWith<_AccountHistoryElement> get copyWith => __$AccountHistoryElementCopyWithImpl<_AccountHistoryElement>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AccountHistoryElement&&(identical(other.id, id) || other.id == id)&&(identical(other.accountId, accountId) || other.accountId == accountId)&&(identical(other.name, name) || other.name == name)&&(identical(other.changeType, changeType) || other.changeType == changeType)&&(identical(other.previousState, previousState) || other.previousState == previousState)&&(identical(other.newState, newState) || other.newState == newState)&&(identical(other.changeTimestamp, changeTimestamp) || other.changeTimestamp == changeTimestamp)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt));
}
...
/// @nodoc
abstract mixin class _$AccountHistoryElementCopyWith<$Res> implements $AccountHistoryElementCopyWith<$Res> {
  factory _$AccountHistoryElementCopyWith(_AccountHistoryElement value, $Res Function(_AccountHistoryElement) _then) = __$AccountHistoryElementCopyWithImpl;
@override @useResult
$Res call({
 int id, int accountId, String name, AccountHistoryChangeType changeType, AccountState? previousState, AccountState newState, DateTime changeTimestamp, DateTime createdAt
});
...
mixin _$AccountHistory {
 ...
 int get accountId; String get accountName; String get currency; Decimal get currentBalance; List<AccountHistoryElement> get history;
...
@useResult
$Res call({
 int accountId, String accountName, String currency, Decimal currentBalance, List<AccountHistoryElement> history
});
...
class _AccountHistory implements AccountHistory {
  const _AccountHistory({required this.accountId, required this.accountName, required this.currency, required this.currentBalance, required final  List<AccountHistoryElement> history}): _history = history;
...
@override List<AccountHistoryElement> get history {
