...
class $CategoriesTable extends Categories
  ...
  @override
  VerificationContext validateIntegrity(Insertable<DatabaseCategory> instance,
...
class $AccountsTable extends Accounts
  ...
  List<GeneratedColumn> get $columns =>
      [id, userId, name, balance, currency, createdAt, updatedAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  @override
  VerificationContext validateIntegrity(Insertable<DatabaseAccount> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
...
class DatabaseAccount extends DataClass implements Insertable<DatabaseAccount> {
  ...
  factory DatabaseAccount.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return DatabaseAccount(
      id: serializer.fromJson<int>(json['id']),
...
class DatabaseTransaction extends DataClass
  ...
  factory DatabaseTransaction.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return DatabaseTransaction(
      id: serializer.fromJson<int>(json['id']),
...
class $AccountStatesTable extends AccountStates
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, accountId, name, balance, currency];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  DatabaseAccountState map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return DatabaseAccountState(
      ...
      name: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}name'])!,
      balance: $AccountStatesTable.$converterbalance.fromSql(attachedDatabase
          .typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}balance'])!),
      currency: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}currency'])!,
...
class DatabaseAccountState extends DataClass
  ...
  factory DatabaseAccountState.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return DatabaseAccountState(
      id: serializer.fromJson<int>(json['id']),
...
class $HistoryElementsTable extends HistoryElements
  ...
  late final GeneratedColumnWithTypeConverter<AccountHistoryChangeType, int>
      changeType = GeneratedColumn<int>('change_type', aliasedName, false,
              type: DriftSqlType.int, requiredDuringInsert: true)
          .withConverter<AccountHistoryChangeType>(
              $HistoryElementsTable.$converterchangeType);
  static const VerificationMeta _previousStateIdMeta =
      const VerificationMeta('previousStateId');
  @override
  late final GeneratedColumn<int> previousStateId = GeneratedColumn<int>(
      'previous_state_id', aliasedName, true,
      type: DriftSqlType.int,
      requiredDuringInsert: false,
      defaultConstraints:
          GeneratedColumn.constraintIsAlways('REFERENCES account_states (id)'));
  static const VerificationMeta _newStateIdMeta =
      const VerificationMeta('newStateId');
  @override
  late final GeneratedColumn<int> newStateId = GeneratedColumn<int>(
      'new_state_id', aliasedName, false,
      type: DriftSqlType.int,
      requiredDuringInsert: true,
      defaultConstraints:
          GeneratedColumn.constraintIsAlways('REFERENCES account_states (id)'));
    ...
    if (data.containsKey('previous_state_id')) {
      context.handle(
          ...
          previousStateId.isAcceptableOrUnknown(
              data['previous_state_id']!, _previousStateIdMeta));
    }
    if (data.containsKey('new_state_id')) {
      context.handle(
          _newStateIdMeta,
          newStateId.isAcceptableOrUnknown(
              data['new_state_id']!, _newStateIdMeta));
    } else if (isInserting) {
    ...
    return DatabaseHistoryElement(
      ...
      changeType: $HistoryElementsTable.$converterchangeType.fromSql(
          attachedDatabase.typeMapping
              .read(DriftSqlType.int, data['${effectivePrefix}change_type'])!),
      previousStateId: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}previous_state_id']),
      newStateId: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}new_state_id'])!,
      createdAt: attachedDatabase.typeMapping
          .read(DriftSqlType.dateTime, data['${effectivePrefix}created_at'])!,
      updatedAt: attachedDatabase.typeMapping
          .read(DriftSqlType.dateTime, data['${effectivePrefix}updated_at'])!,
...
class DatabaseHistoryElement extends DataClass
  ...
  factory DatabaseHistoryElement.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return DatabaseHistoryElement(
      id: serializer.fromJson<int>(json['id']),
      accountId: serializer.fromJson<int>(json['accountId']),
      name: serializer.fromJson<String>(json['name']),
      changeType: $HistoryElementsTable.$converterchangeType
          .fromJson(serializer.fromJson<int>(json['changeType'])),
  ...
  DatabaseHistoryElement copyWithCompanion(HistoryElementsCompanion data) {
    return DatabaseHistoryElement(
      ...
      previousStateId: data.previousStateId.present
          ...
          : this.previousStateId,
      newStateId:
          data.newStateId.present ? data.newStateId.value : this.newStateId,
      createdAt: data.createdAt.present ? data.createdAt.value : this.createdAt,
      updatedAt: data.updatedAt.present ? data.updatedAt.value : this.updatedAt,
    );
  }
  ...
  @override
  int get hashCode => Object.hash(id, accountId, name, changeType,
      previousStateId, newStateId, createdAt, updatedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
abstract class _$Database extends GeneratedDatabase {
  ...
  late final $HistoryElementsTable historyElements =
      $HistoryElementsTable(this);
  @override
  Iterable<TableInfo<Table, Object?>> get allTables =>
      allSchemaEntities.whereType<TableInfo<Table, Object?>>();
  @override
  List<DatabaseSchemaEntity> get allSchemaEntities =>
      [categories, accounts, transactions, accountStates, historyElements];
}
...
final class $$CategoriesTableReferences
  ...
  static MultiTypedResultKey<$TransactionsTable, List<DatabaseTransaction>>
      _transactionsRefsTable(_$Database db) =>
          ...
          prefetchHooksCallback: ({transactionsRefs = false}) {
            return PrefetchHooks(
              ...
              getPrefetchedDataCallback: (items) async {
                return [
                  if (transactionsRefs)
                    await $_getPrefetchedData<DatabaseCategory,
                            $CategoriesTable, DatabaseTransaction>(
                        currentTable: table,
...
final class $$AccountsTableReferences
  ...
  static MultiTypedResultKey<$AccountStatesTable, List<DatabaseAccountState>>
      _accountStatesRefsTable(_$Database db) => MultiTypedResultKey.fromTable(
          db.accountStates,
          aliasName:
              $_aliasNameGenerator(db.accounts.id, db.accountStates.accountId));

  $$AccountStatesTableProcessedTableManager get accountStatesRefs {
    final manager = $$AccountStatesTableTableManager($_db, $_db.accountStates)
        .filter((f) => f.accountId.id.sqlEquals($_itemColumn<int>('id')!));
  ...
  static MultiTypedResultKey<$HistoryElementsTable,
      List<DatabaseHistoryElement>> _historyElementsRefsTable(
          _$Database db) =>
      MultiTypedResultKey.fromTable(db.historyElements,
          aliasName: $_aliasNameGenerator(
              db.accounts.id, db.historyElements.accountId));
  ...
  $$HistoryElementsTableProcessedTableManager get historyElementsRefs {
    ...
    final cache =
        $_typedResult.readTableOrNull(_historyElementsRefsTable($_db));
    return ProcessedTableManager(
        manager.$state.copyWith(prefetchedData: cache));
  }
}
          ...
          prefetchHooksCallback: (
            ...
            return PrefetchHooks(
              ...
              getPrefetchedDataCallback: (items) async {
                return [
                  if (transactionsRefs)
                    await $_getPrefetchedData<DatabaseAccount, $AccountsTable,
                            DatabaseTransaction>(
                        currentTable: table,
...
final class $$TransactionsTableReferences extends BaseReferences<_$Database,
    $TransactionsTable, DatabaseTransaction> {
...
typedef $$TransactionsTableProcessedTableManager = ProcessedTableManager<
    ...
    DatabaseTransaction,
    PrefetchHooks Function({bool accountId, bool categoryId})>;
typedef $$AccountStatesTableCreateCompanionBuilder = AccountStatesCompanion
    Function({
  Value<int> id,
  required int accountId,
  required String name,
...
typedef $$AccountStatesTableUpdateCompanionBuilder = AccountStatesCompanion
    Function({
  Value<int> id,
  Value<int> accountId,
  Value<String> name,
...
final class $$AccountStatesTableReferences extends BaseReferences<_$Database,
    $AccountStatesTable, DatabaseAccountState> {
  ...
  static MultiTypedResultKey<$HistoryElementsTable,
      List<DatabaseHistoryElement>> _previousStateIdTable(
          _$Database db) =>
      MultiTypedResultKey.fromTable(db.historyElements,
          aliasName: $_aliasNameGenerator(
              db.accountStates.id, db.historyElements.previousStateId));

  $$HistoryElementsTableProcessedTableManager get previousStateId {
    final manager =
        $$HistoryElementsTableTableManager($_db, $_db.historyElements).filter(
            (f) => f.previousStateId.id.sqlEquals($_itemColumn<int>('id')!));
  ...
  static MultiTypedResultKey<$HistoryElementsTable,
      List<DatabaseHistoryElement>> _newStateIdTable(
          _$Database db) =>
      MultiTypedResultKey.fromTable(db.historyElements,
          aliasName: $_aliasNameGenerator(
              db.accountStates.id, db.historyElements.newStateId));
...
class $$AccountStatesTableTableManager extends RootTableManager<
    _$Database,
    $AccountStatesTable,
    DatabaseAccountState,
    $$AccountStatesTableFilterComposer,
    ...
    DatabaseAccountState,
    PrefetchHooks Function(
        {bool accountId, bool previousStateId, bool newStateId})> {
          ...
          prefetchHooksCallback: (
            ...
            return PrefetchHooks(
              ...
              addJoins: <
                ...
                if (accountId) {
                  state = state.withJoin(
                    ...
                    currentColumn: table.accountId,
                    referencedTable:
                        $$AccountStatesTableReferences._accountIdTable(db),
                    referencedColumn:
                        $$AccountStatesTableReferences._accountIdTable(db).id,
                  ) as T;
                }
              ...
              getPrefetchedDataCallback: (items) async {
                return [
                  if (previousStateId)
                    await $_getPrefetchedData<DatabaseAccountState,
                            $AccountStatesTable, DatabaseHistoryElement>(
                        currentTable: table,
                        referencedTable: $$AccountStatesTableReferences
                            ._previousStateIdTable(db),
                        managerFromTypedResult: (p0) =>
                            $$AccountStatesTableReferences(db, table, p0)
                                .previousStateId,
                        referencedItemsForCurrentItem:
                            (item, referencedItems) => referencedItems
                                .where((e) => e.previousStateId == item.id),
                        typedResults: items),
                  if (newStateId)
                    await $_getPrefetchedData<DatabaseAccountState,
                            $AccountStatesTable, DatabaseHistoryElement>(
                        currentTable: table,
                        referencedTable:
                            $$AccountStatesTableReferences._newStateIdTable(db),
                        managerFromTypedResult: (p0) =>
                            $$AccountStatesTableReferences(db, table, p0)
                                .newStateId,
                        referencedItemsForCurrentItem:
                            (item, referencedItems) => referencedItems
                                .where((e) => e.newStateId == item.id),
                        typedResults: items)
                ];
              },
            );
...
typedef $$AccountStatesTableProcessedTableManager = ProcessedTableManager<
    _$Database,
    $AccountStatesTable,
    DatabaseAccountState,
    $$AccountStatesTableFilterComposer,
    ...
    PrefetchHooks Function(
        {bool accountId, bool previousStateId, bool newStateId})>;
typedef $$HistoryElementsTableCreateCompanionBuilder = HistoryElementsCompanion
    Function({
  Value<int> id,
  required int accountId,
  required String name,
...
typedef $$HistoryElementsTableUpdateCompanionBuilder = HistoryElementsCompanion
    Function({
  Value<int> id,
  Value<int> accountId,
  Value<String> name,
...
final class $$HistoryElementsTableReferences extends BaseReferences<_$Database,
    $HistoryElementsTable, DatabaseHistoryElement> {
  ...
  static $AccountStatesTable _previousStateIdTable(_$Database db) =>
      db.accountStates.createAlias($_aliasNameGenerator(
          db.historyElements.previousStateId, db.accountStates.id));
  ...
  static $AccountStatesTable _newStateIdTable(_$Database db) =>
      db.accountStates.createAlias($_aliasNameGenerator(
          db.historyElements.newStateId, db.accountStates.id));
...
class $$HistoryElementsTableFilterComposer
  ...
  ColumnWithTypeConverterFilters<AccountHistoryChangeType,
          AccountHistoryChangeType, int>
...
class $$HistoryElementsTableTableManager extends RootTableManager<
    _$Database,
  ...
  $$HistoryElementsTableTableManager(_$Database db, $HistoryElementsTable table)
      : super(TableManagerState(
          ...
          updateCompanionCallback: ({
            ...
            Value<int> accountId = const Value.absent(),
            Value<String> name = const Value.absent(),
            Value<AccountHistoryChangeType> changeType = const Value.absent(),
            Value<int?> previousStateId = const Value.absent(),
              ...
              addJoins: <
                ...
                if (accountId) {
                  state = state.withJoin(
                    ...
                    currentColumn: table.accountId,
                    referencedTable:
                        $$HistoryElementsTableReferences._accountIdTable(db),
                    referencedColumn:
                        $$HistoryElementsTableReferences._accountIdTable(db).id,
                  ) as T;
                }
                if (previousStateId) {
                  state = state.withJoin(
                    ...
                    referencedTable: $$HistoryElementsTableReferences
                        ._previousStateIdTable(db),
                    referencedColumn: $$HistoryElementsTableReferences
                        ._previousStateIdTable(db)
                        .id,
                  ) as T;
                }
                if (newStateId) {
                  state = state.withJoin(
                    ...
                    referencedTable:
                        $$HistoryElementsTableReferences._newStateIdTable(db),
                    referencedColumn: $$HistoryElementsTableReferences
                        ._newStateIdTable(db)
                        .id,
                  ) as T;
...
typedef $$HistoryElementsTableProcessedTableManager = ProcessedTableManager<
    _$Database,
    $HistoryElementsTable,
    DatabaseHistoryElement,
    $$HistoryElementsTableFilterComposer,
